...
public class JDBCIOExample {
    ...
    public static void main(String[] args) {
        ...
        PCollection<String> pOut = p.apply(JdbcIO.<String>read().withDataSourceConfiguration(
        ...
        pOut.apply(TextIO.write().to("src/main/resources/data/jdbc").withNumShards(1).withSuffix(".csv"));
