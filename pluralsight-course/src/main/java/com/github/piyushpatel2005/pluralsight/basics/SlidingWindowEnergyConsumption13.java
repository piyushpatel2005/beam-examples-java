...
public class SlidingWindowEnergyConsumption13 {
    public static void main(String[] args) {
        ...
        energyConsumption.apply("Window", Window.into(SlidingWindows.of(
                Duration.standardDays(5)).every(Duration.standardDays(1))))
